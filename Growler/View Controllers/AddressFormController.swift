...
class AddressFormController: FormTableViewController {
    ...
    override func getItems() -> [FormTableCell] {
        return [
            ...
            FormTableCell.create(title: "Address 2", name: AddressFields.address2.rawValue, required: false),
            ...
            FormTableCell.create(title: "Country Code", name: AddressFields.countryCode.rawValue, required: false, `default`: "US"),
            FormTableCell.create(title: "Province Code", name: AddressFields.provinceCode.rawValue, required: false, `default`: "MN"),
